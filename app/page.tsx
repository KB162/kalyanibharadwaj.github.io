  ...
  return (
    <main style={{ padding: "40px", fontFamily: "Arial" }}>
      ...
      <ul>
        ...
        <li>Robotics -
          I have recently built an interest in robotics and since I am a CS student I am learning it by making small electronics projects and integrating the computer vision knowledege from cs231 in it 
          1.Gesture controlled LED 
